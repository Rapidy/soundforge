       ...
       return (
        <div key={this.props.album.id} className="content-list__item">
          <div className="content-list__func">
              <span className="content-list__link" onClick = {this.props.UserFavoritesAdd.bind(this, this.props.album.id, 'albums')}>
                <span className='content-list__icon content-list__heart'></span>
